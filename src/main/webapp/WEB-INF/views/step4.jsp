...
<html>
    <head>
        ...
        <title>Update the application to the approved state</title>
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                %>
                <p style="font-size:170%;">Step 04: <small>Update the application to the approved state </small></p><br>
                <form style="font-size:120%;" method="GET" action="updateApplication">
