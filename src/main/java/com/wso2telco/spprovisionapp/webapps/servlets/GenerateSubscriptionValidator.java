...
@WebServlet(urlPatterns = {"/populateSubscriptionValidator"})
public class GenerateSubscriptionValidator extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        dispatcher = request.getServletContext()
                .getRequestDispatcher("/WEB-INF/views/step8.jsp");
